...
// Symfony Route/AbstractController
{
    ...
    public function home_page()
    {
        ...
        //utilisation de la fonction php array slice affin d'afficher les 3 dernier livre de ma bdd
        $last_books = array_slice($books, 2);
        //j'utilise la méthode render afin d'afficher (ma view) cad le resultat de la requete sous forme d'html
        //grace au fichier twig
        return $this->render('home_page.html.twig',['books' => $last_books ]);
